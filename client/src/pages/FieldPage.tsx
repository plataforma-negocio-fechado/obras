...
const typeLabel: Record<FieldCandidate["type"], string> = { producao: "Produção", custo: "Custo", material: "Material", maquina: "Máquina", equipe: "Equipe", ocorrencia: "Ocorrência", acao: "Ação", diario: "Diário" };
